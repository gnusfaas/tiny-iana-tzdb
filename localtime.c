...
*/
extern int tz_access1(const char *path, int amode);
extern int tz_open1(const char *path, int oflag, ... );
/*LINTLIBRARY*/
	   ...
	   union local_storage *lsp)
{
	...
	# ifdef INTERCEPT
	if (doaccess && tz_access1(name, R_OK) != 0)
	  return errno;
	# else
